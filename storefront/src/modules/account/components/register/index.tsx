    ...
    >
      ...
      <form className="w-full flex flex-col" style={{ maxWidth: 'min(100%, 400px)' }} action={formAction}>
        ...
        <SubmitButton 
          ...
          className="group relative seasun-body text-white w-full overflow-hidden transform transition-all duration-500 ease-out hover:scale-105 hover:-translate-y-1 shadow-xl active:scale-95 active:translate-y-0 focus:outline-none focus:ring-4 focus:ring-black/20 focus:ring-offset-4 focus:ring-offset-transparent rounded-xl font-medium mt-[clamp(1.5rem,5vh,2.5rem)] bg-[var(--seasun-deep-black)]"
        >
